...
"}"));
        ...
        horizontalLayoutWidget->setGeometry(QRect(0, 0, 1135, 731));
        ...
        gameOverBlock = new QWidget(gameOver);
        gameOverBlock->setObjectName(QStringLiteral("gameOverBlock"));
        gameOverBlock->setGeometry(QRect(170, 200, 791, 441));
        verticalLayout_2 = new QVBoxLayout(gameOverBlock);
        verticalLayout_2->setObjectName(QStringLiteral("verticalLayout_2"));
        gameOverLayout = new QVBoxLayout();
        gameOverLayout->setObjectName(QStringLiteral("gameOverLayout"));
        yourStatusLabel = new QLabel(gameOverBlock);
        yourStatusLabel->setObjectName(QStringLiteral("yourStatusLabel"));
        yourStatusLabel->setAlignment(Qt::AlignCenter);

        gameOverLayout->addWidget(yourStatusLabel);

        redPointsLabel = new QLabel(gameOverBlock);
        redPointsLabel->setObjectName(QStringLiteral("redPointsLabel"));
        redPointsLabel->setAlignment(Qt::AlignCenter);

        gameOverLayout->addWidget(redPointsLabel);

        bluePointsLabel = new QLabel(gameOverBlock);
        bluePointsLabel->setObjectName(QStringLiteral("bluePointsLabel"));
        bluePointsLabel->setAlignment(Qt::AlignCenter);

        gameOverLayout->addWidget(bluePointsLabel);

        topSummary = new QTableWidget(gameOverBlock);
        if (topSummary->columnCount() < 2)
            topSummary->setColumnCount(2);
        QTableWidgetItem *__qtablewidgetitem26 = new QTableWidgetItem();
        topSummary->setHorizontalHeaderItem(0, __qtablewidgetitem26);
        QTableWidgetItem *__qtablewidgetitem27 = new QTableWidgetItem();
        topSummary->setHorizontalHeaderItem(1, __qtablewidgetitem27);
        if (topSummary->rowCount() < 8)
            topSummary->setRowCount(8);
        QTableWidgetItem *__qtablewidgetitem28 = new QTableWidgetItem();
        topSummary->setVerticalHeaderItem(0, __qtablewidgetitem28);
        QTableWidgetItem *__qtablewidgetitem29 = new QTableWidgetItem();
        topSummary->setVerticalHeaderItem(1, __qtablewidgetitem29);
        QTableWidgetItem *__qtablewidgetitem30 = new QTableWidgetItem();
        topSummary->setVerticalHeaderItem(2, __qtablewidgetitem30);
        QTableWidgetItem *__qtablewidgetitem31 = new QTableWidgetItem();
        topSummary->setVerticalHeaderItem(3, __qtablewidgetitem31);
        QTableWidgetItem *__qtablewidgetitem32 = new QTableWidgetItem();
        topSummary->setVerticalHeaderItem(4, __qtablewidgetitem32);
        QTableWidgetItem *__qtablewidgetitem33 = new QTableWidgetItem();
        topSummary->setVerticalHeaderItem(5, __qtablewidgetitem33);
        QTableWidgetItem *__qtablewidgetitem34 = new QTableWidgetItem();
        topSummary->setVerticalHeaderItem(6, __qtablewidgetitem34);
        QTableWidgetItem *__qtablewidgetitem35 = new QTableWidgetItem();
        topSummary->setVerticalHeaderItem(7, __qtablewidgetitem35);
        topSummary->setObjectName(QStringLiteral("topSummary"));
        topSummary->setEditTriggers(QAbstractItemView::NoEditTriggers);
        topSummary->setSelectionMode(QAbstractItemView::NoSelection);
        topSummary->setCornerButtonEnabled(false);
        topSummary->horizontalHeader()->setDefaultSectionSize(500);
        topSummary->horizontalHeader()->setStretchLastSection(true);

        gameOverLayout->addWidget(topSummary);

        exitGameOverButton = new QPushButton(gameOverBlock);
        exitGameOverButton->setObjectName(QStringLiteral("exitGameOverButton"));

        gameOverLayout->addWidget(exitGameOverButton);


        verticalLayout_2->addLayout(gameOverLayout);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        serverIpEdit->setText(QApplication::translate("MainWindow", "127.0.0.1", 0));
...
"square", 0));
        ...
        timeLabel->setText(QApplication::translate("MainWindow", "Czas: 23:45 / 23:45", 0));
        ...
        yourStatusLabel->setText(QApplication::translate("MainWindow", "Wygrana!", 0));
        redPointsLabel->setText(QApplication::translate("MainWindow", "<font color=\"#f00\">Czerwoni: 0 punkt\303\263w</font>", 0));
        bluePointsLabel->setText(QApplication::translate("MainWindow", "Niebiescy: 0 punkt\303\263w", 0));
        QTableWidgetItem *___qtablewidgetitem26 = topSummary->horizontalHeaderItem(0);
        ___qtablewidgetitem26->setText(QApplication::translate("MainWindow", "Gracz", 0));
        QTableWidgetItem *___qtablewidgetitem27 = topSummary->horizontalHeaderItem(1);
        ___qtablewidgetitem27->setText(QApplication::translate("MainWindow", "Punkty", 0));
        QTableWidgetItem *___qtablewidgetitem28 = topSummary->verticalHeaderItem(0);
        ___qtablewidgetitem28->setText(QApplication::translate("MainWindow", "1", 0));
        QTableWidgetItem *___qtablewidgetitem29 = topSummary->verticalHeaderItem(1);
        ___qtablewidgetitem29->setText(QApplication::translate("MainWindow", "2", 0));
        QTableWidgetItem *___qtablewidgetitem30 = topSummary->verticalHeaderItem(2);
        ___qtablewidgetitem30->setText(QApplication::translate("MainWindow", "3", 0));
        QTableWidgetItem *___qtablewidgetitem31 = topSummary->verticalHeaderItem(3);
        ___qtablewidgetitem31->setText(QApplication::translate("MainWindow", "4", 0));
        QTableWidgetItem *___qtablewidgetitem32 = topSummary->verticalHeaderItem(4);
        ___qtablewidgetitem32->setText(QApplication::translate("MainWindow", "5", 0));
        QTableWidgetItem *___qtablewidgetitem33 = topSummary->verticalHeaderItem(5);
        ___qtablewidgetitem33->setText(QApplication::translate("MainWindow", "6", 0));
        QTableWidgetItem *___qtablewidgetitem34 = topSummary->verticalHeaderItem(6);
        ___qtablewidgetitem34->setText(QApplication::translate("MainWindow", "7", 0));
        QTableWidgetItem *___qtablewidgetitem35 = topSummary->verticalHeaderItem(7);
        ___qtablewidgetitem35->setText(QApplication::translate("MainWindow", "8", 0));
        exitGameOverButton->setText(QApplication::translate("MainWindow", "Wr\303\263\304\207 do menu", 0));
    } // retranslateUi
